...
public class ThriftClientTest {
	...
	public static void main(String[] args) throws TException {
		...
		String server =  ServerRegisterUtil.get("IndexNewsOperatorServices");
		...
		TTransport transport = new TSocket(StringUtils.substringBefore(server, ":"), Integer.parseInt(StringUtils.substringAfter(server, ":")));
